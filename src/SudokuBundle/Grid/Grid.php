...
class Grid
{
	...
	/**
	 * @return \SudokuBundle\Grid\Cell[]
	 */
	public function getEmptyCells()
	{
		return array_filter($this->sequence, function($cell){
			/* @var $cell \SudokuBundle\Grid\Cell */
			return $cell->isEmpty();
		});
	}
	 ...
	 * @return null|Cell
	 */
	public function getRandomEmptyCell()
	{
		foreach($this->sequence as $cell) {
			/* @var $cell \SudokuBundle\Grid\Cell */
			if ($cell->isEmpty()) {
				return $cell;
			}
